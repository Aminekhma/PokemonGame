...
public abstract class Plante extends Pokemon implements Attaquer{
	
	public Plante(String nom) {
		super(nom);
		int min=40, max=60; //les stats seront compris entre ces nombres
		
		type=3; //1:Eau  2:Feu  3:Plante
		...
		def+=(def*20)/100; //les pokemons de type Plante ont +20% en defense
	}
	...
	public String toString(){
		return "Je suis un pokemon de type Plante !";
	}
